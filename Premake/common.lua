...
dirs["juceModules"]		= os.realpath(dirs.root .. "Source/Engine/External/JUCE/modules/")
dirs["juceConfig"]		= os.realpath(dirs.root .. "Source/Engine/AudioEngine/JuceLibraryCode/")
...
dirs["audioEngine"] 	= os.realpath(dirs.root .. "Source/Engine/AudioEngine/")
